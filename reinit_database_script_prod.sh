...
python3 $homeDir/bodzify-api/manage.py migrate --fake-initial
python3 $homeDir/bodzify-api/manage.py migrate
python3 $homeDir/bodzify-api/manage.py makemigrations bodzify_api
python3 $homeDir/bodzify-api/manage.py migrate
python3 $homeDir/bodzify-api/manage.py loaddata initial_data
python3 $homeDir/bodzify-api/manage.py runserver