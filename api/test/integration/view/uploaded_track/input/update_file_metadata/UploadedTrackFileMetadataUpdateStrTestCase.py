...
from api.test.integration.view.uploaded_track.input.update_file_metadata.UploadedTrackFileMetadataUpdateTestCase import UploadedTrackFileMetadataUpdateTestCase
