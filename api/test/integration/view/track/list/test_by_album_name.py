...
class TestCase(TrackTestCase, NullableCharFilterTestCase):
    ...
    def test_empty_then_results(self):
        ...
        self.model_fixture_factory.create_track_with_file(title="Hey", album=album)

        response = self._list_tracks(album_name='')
    ...
    def test_filter_not_empty_then_dont_return_track_with_no_album(self):
        ...
        response = self._list_tracks(album_name='jo')
    ...
    def test_contains_in_another_case_then_results(self):
        ...
        track_life = self.model_fixture_factory.create_track_with_file(title="Life", album=album_life)
        album_hey = self.model_fixture_factory.create_album(name="Hey")
        self.model_fixture_factory.create_track_with_file(title="Hey", album=album_hey)

        response = self._list_tracks(album_name='Lif')
