...
class TestCase(TrackTestCase, NullableCharFilterTestCase):
    ...
    def test_not_provided_then_results(self):
        track = self.model_fixture_factory.create_track_with_file(title="Life", language="en")
    ...
    def test_empty_then_results(self):
        self.model_fixture_factory.create_track_with_file(title="Life", language="en")
        self.model_fixture_factory.create_track_with_file(title="Hey", language="fr")
        self.model_fixture_factory.create_track_with_file(title="Hey haa")

        response = self._list_tracks(language='')
    ...
    def test_contains_in_another_case_then_results(self):
        ...
        response = self._list_tracks(language='E')
