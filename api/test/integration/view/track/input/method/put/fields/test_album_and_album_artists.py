...
class TestCase(TrackTestCase, PutBodyDataTestCase):
    ...
    def test_not_provided_then_unchanged(self):
        ...
        track = self.model_fixture_factory.create_track_with_file(title="Love", album=album)

        response = self._put_track(track.uuid, **{PutFields.ARCHIVED: True})
    ...
    def test_empty_then_none(self):
        ...
        track = self.model_fixture_factory.create_track_with_file(title="koko", album=album_old)
    ...
    def test_nothing_linked_to_old_album_anymore_then_delete_it(self):
        ...
        track = self.model_fixture_factory.create_track_with_file(title="Foire", album=old_album)
    ...
    def test_a_track_still_linked_to_old_album_then_not_delete_it(self):
        ...
        track = self.model_fixture_factory.create_track_with_file(title="Foire", album=album)
    ...
    def test_not_delete_old_album_artist_because_annother_album_with_a_track_linked_to_it(self):
        ...
        self.model_fixture_factory.create_track_with_file(title="Josie", album=album2)
