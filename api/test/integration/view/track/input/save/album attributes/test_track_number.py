...
class TestCase(TrackTestCase, NullablePositiveIntBodyDataTestCase):
    ...
    def test_empty_then_none(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.TRACK_NUMBER: None})
    ...
    def test_empty_string_then_none(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.TRACK_NUMBER: ''})
    ...
    def test_string_castable_then_ok(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **
    ...
    def string_castable_then_ok(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.TRACK_NUMBER: '5'})
    ...
    def test_zero_then_400_bad_request(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.TRACK_NUMBER: 0})
    ...
    def test_too_large_then_400_bad_request(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3,
            **{PostFields.ALBUM_NAME: 'album', PostFields.TRACK_NUMBER: settings.TRACK_TRACK_NUMBER_MAX + 1})
    ...
    def test_negative_then_400_bad_request(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.TRACK_NUMBER: -1})
    ...
    def test_float_then_400_bad_request(self):
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.TRACK_NUMBER: 5.5})
