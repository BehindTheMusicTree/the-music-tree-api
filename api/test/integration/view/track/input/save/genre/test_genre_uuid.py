...
class TestCase(ForeignKeyBodyDataTestCase, TrackTestCase):
    ...
    def test_existing_then_ok(self):
        ...
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.GENRE: genre.uuid})
    ...
    def test_empty_then_none(self):
        response = self._post_track(TrackTestFilename.METADATA_NONE_MP3, **{PostFields.GENRE: ""})
    ...
    def test_multi_value_then_400_bad_request(self):
        ...
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.GENRE: [genre.uuid, genre.uuid]})
    ...
    def test_invalid_uuid_then_400_bad_request(self):
        ...
        response = self._post_track(
            TrackTestFilename.METADATA_NONE_MP3, **{PostFields.GENRE: invalid_uuid})
