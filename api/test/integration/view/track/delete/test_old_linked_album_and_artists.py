...
class TestCase(TrackTestCase):
    ...
    def test_linked_album_then_delete_it_as_nothing_linked_to_it_anymore(self):
        ...
        track = self.model_fixture_factory.create_track_with_file(title="We're All To Blame", album=album)
    ...
    def test_linked_artist_then_delete_it_as_nothing_linked_to_it_anymore(self):
        ...
        track = self.model_fixture_factory.create_track_with_file(title="We're All To Blame", artists=[artist])
