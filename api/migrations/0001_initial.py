# Generated by Django 5.2.8 on 2025-12-09 22:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('code', models.PositiveIntegerField(choices=[(0, 'Audio Meta Amalysis Disabled'), (1, 'Duration Below Or Equal 1 Sec'), (2, 'Lookup Found No Matching Recording'), (3, 'Lookup Failed Due To Invalid Fingerprint'), (4, 'Lookup Failed With Internal Error'), (5, 'Lookup Failed With Unknown Response Error Code'), (6, 'Lookup Failed With Unknown Response Status Code'), (7, 'Lookup Failed Dns Resolution Error')], primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_in_sec', models.PositiveIntegerField(blank=True, null=True)),
                ('album', api.model.field.foreign_key.PrivateForeignKey.PrivateForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tracks_of_album', to='api.album')),
                ('artists', api.model.field.foreign_key.PrivateManyToManyField.PrivateManyToManyField(blank=True, related_name='tracks_of_artist', to='api.artist')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Track',
                'verbose_name_plural': 'Tracks',
                'db_table': 'the_music_tree_api_track',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playlist', api.model.field.foreign_key.PrivateForeignKey.PrivateForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='track_playlist_rels', to='api.playlist')),
                ('track', api.model.field.foreign_key.PrivateForeignKey.PrivateForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='track_playlist_rels', to='api.track')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Track Playlist Relation',
                'verbose_name_plural': 'Track Playlist Relations',
                'db_table': 'the_music_tree_api_track_playlist_rel',
            },
        ),
        migrations.AddField(
            model_name='track',
            name='playlists',
            field=api.model.field.foreign_key.PrivateManyToManyField.PrivateManyToManyField(related_name='tracks_of_playlist', through='api.TrackPlaylistRel', to='api.playlist'),
        ),
        migrations.CreateModel(
            name='AllTracksMixin',
            fields=[
            ...
            options={
                ...
                'db_table': 'the_music_tree_api_all_tracks_mixin',
        ...
        migrations.AddField(
            model_name='track',
            name='genre',
            field=api.model.field.foreign_key.PrivateForeignKey.PrivateForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='tracks_of_criteria', to='api.genre'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='play',
            index=models.Index(fields=['user', 'content_type', 'content_uuid'], name='the_music_t_user_id_fad3ac_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'playlist'], name='the_music_t_user_id_737e70_idx'),
        ),
        migrations.AddIndex(
            model_name='trackplaylistrel',
            index=models.Index(fields=['user', 'track'], name='the_music_t_user_id_3e497e_idx'),
        ),
        migrations.AddIndex(
            model_name='track',
            index=models.Index(fields=['user', 'title'], name='the_music_t_user_id_77ef2c_idx'),
        ),
        migrations.AddIndex(
            model_name='track',
            index=models.Index(fields=['user', 'genre'], name='the_music_t_user_id_d08264_idx'),
        ),
        migrations.AddIndex(
            model_name='track',
            index=models.Index(fields=['user', 'album'], name='the_music_t_user_id_0fcb0f_idx'),
        ),
        migrations.AddIndex(
            model_name='criteriaplaylist',
