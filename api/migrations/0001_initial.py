...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'playlist'], name='the_music_tree_api_user_id_eedb66_idx'),
        ),
        migrations.AddIndex(
            model_name='trackplaylistrel',
            index=models.Index(fields=['user', 'track'], name='the_music_tree_api_user_id_e2333a_idx'),
        ),
        migrations.AddIndex(
            model_name='track',
            index=models.Index(fields=['user', 'title'], name='the_music_tree_api_user_id_798999_idx'),
        ),
        migrations.AddIndex(
            model_name='track',
            index=models.Index(fields=['user', 'genre'], name='the_music_tree_api_user_id_6a9c83_idx'),
        ),
        migrations.AddIndex(
            model_name='track',
            index=models.Index(fields=['user', 'album'], name='the_music_tree_api_user_id_b8c4d5_idx'),
        ),
        migrations.AddIndex(
            model_name='criteriaplaylist',
