    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotify_library_last_synced_at', models.DateTimeField(blank=True,
                 help_text="Timestamp of when the user's Spotify library was last synced", null=True)),
                ('spotify_sync_in_progress', models.BooleanField(default=False,
