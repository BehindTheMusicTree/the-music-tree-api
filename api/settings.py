...
def setup_app_constants():
    ...
    global TRACK_FILE_SIZE_MIN_IN_MO
    TRACK_FILE_SIZE_MIN_IN_MO = 0
    global TRACK_FILE_SIZE_MAX_IN_MO
    TRACK_FILE_SIZE_MAX_IN_MO = 300
    ...
    DATA_UPLOAD_MAX_MEMORY_SIZE = TRACK_FILE_SIZE_MAX_IN_MO * 1024 * 1024  # Convert MB to bytes

    global TRACK_FILE_EXTENSIONS
    TRACK_FILE_EXTENSIONS = ['.mp3', '.flac', '.wav']
    global TRACK_FILE_CONTENT_TYPES
    TRACK_FILE_CONTENT_TYPES = ['audio/mpeg', 'audio/flac', 'audio/wav']
    global TRACK_FILENAME_LEN_MAX
    TRACK_FILENAME_LEN_MAX = 150
    global TRACK_FILENAME_GENERATED_WITHOUT_EXTENSION_LENGTH
    TRACK_FILENAME_GENERATED_WITHOUT_EXTENSION_LENGTH = 20
    global TRACK_TITLE_LEN_MAX
    TRACK_TITLE_LEN_MAX = 256
    global TRACK_TITLE_LEN_MAX_ID3V1
    TRACK_TITLE_LEN_MAX_ID3V1 = 30
    global TRACK_TRACK_NUMBER_MAX
    TRACK_TRACK_NUMBER_MAX = 1000
    global TRACK_FILENAME_EXPRESSIONS_TO_EXCLUDE_GENERATING_TITLE
    TRACK_FILENAME_EXPRESSIONS_TO_EXCLUDE_GENERATING_TITLE = [
        'myfreemp3.vip', 'myfreemp3']  # The order matters
    global TRACK_GENERATED_TITLE_LENGTH
    TRACK_GENERATED_TITLE_LENGTH = 20
    global TRACK_GENERATED_TITLE_PREFIXE
    TRACK_GENERATED_TITLE_PREFIXE = "the_music_tree_"
