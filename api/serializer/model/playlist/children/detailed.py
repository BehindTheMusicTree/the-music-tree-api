...
class Fields:
    ...
    UPLOADED_TRACK_PLAYLIST_RELS_INTERNAL = PlayListFields.TRACK_PLAYLIST_RELS_INTERNAL
    UPLOADED_TRACK_PLAYLIST_RELS_PUBLIC = PlayListFields.TRACK_PLAYLIST_RELS_PUBLIC
...
class ChildPlaylistSerializer(PlaylistSimpleSerializer):
    ...
    tracks = serializers.ListField(source=Fields.UPLOADED_TRACKS_NOT_ARCHIVED_INTERNAL)
