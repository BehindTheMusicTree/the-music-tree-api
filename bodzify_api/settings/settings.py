...
AUDIO_FINGERPRINT_GENERATOR_BASE_URL = "http://127.0.0.1"
AUDIO_FINGERPRINT_GENERATOR_PORT = os.getenv('AUDIO_FINGERPRINT_GENERATOR_PORT')
if AUDIO_FINGERPRINT_GENERATOR_PORT is None:
    raise Exception("AUDIO_FINGERPRINT_GENERATOR_PORT env variable is not set")
AUDIO_FINGERPRINT_GENERATOR_POST_ENDPOINT = "/generate-audio-fingerprint"
AUDIO_FINGERPRINT_GENERATOR_POST_FULL_URL = AUDIO_FINGERPRINT_GENERATOR_BASE_URL + \
    ":" + AUDIO_FINGERPRINT_GENERATOR_PORT + \
    AUDIO_FINGERPRINT_GENERATOR_POST_ENDPOINT

FILE_UPLOAD_TEMP_DIR = '/var/django_temp_uploaded_files/'
