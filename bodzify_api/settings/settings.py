...
class ENV_CONFIG_KEYS:
    ...
    AUDIO_FINGERPRINT_NEEDED = 'AUDIO_FINGERPRINT_NEEDED'
...
ENV_SETTINGS = {
    ENV_VALUES.DEV: {
        ...
        ENV_CONFIG_KEYS.AUDIO_FINGERPRINT_NEEDED: True,
    },
    ENV_VALUES.CI_TEST: {
        ENV_CONFIG_KEYS.DEBUG: True,
        ENV_CONFIG_KEYS.LOG_AND_MEDIA_AND_STATIC_DIRS_REQUIRED: False,
    ...
    ENV_VALUES.COLLECT_STATIC: {
        ...
        ENV_CONFIG_KEYS.AUDIO_FINGERPRINT_NEEDED: False,
    },
    ENV_VALUES.TEST: {
        ENV_CONFIG_KEYS.DEBUG: True,
...
if AUDIO_FINGERPRINTER_PORT is None and current_env_settings.get(ENV_CONFIG_KEYS.AUDIO_FINGERPRINT_NEEDED):
