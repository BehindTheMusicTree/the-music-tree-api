...
class ErrorHTTPStatusCodeMap:
    ...
    ERROR_TO_HTTP_STATUS = {
        ...
        ErrorCode.VALIDATION_INVALID_UUID: status.HTTP_400_BAD_REQUEST,
        ErrorCode.VALIDATION_INTEGRITY_ERROR: status.HTTP_400_BAD_REQUEST,

        # Resource errors -> 404/409
        ErrorCode.RESOURCE_NOT_FOUND: status.HTTP_404_NOT_FOUND,
        ErrorCode.RESOURCE_ALREADY_EXISTS: status.HTTP_409_CONFLICT,
        ErrorCode.RESOURCE_FILE_NOT_FOUND: status.HTTP_404_NOT_FOUND,
        ErrorCode.RESOURCE_INVALID_STATE: status.HTTP_409_CONFLICT,

        # Business Logic errors -> 422
        ErrorCode.BUSINESS_INVALID_OPERATION: status.HTTP_422_UNPROCESSABLE_ENTITY,
        ErrorCode.BUSINESS_DEPENDENCY_ERROR: status.HTTP_422_UNPROCESSABLE_ENTITY,
        ErrorCode.BUSINESS_LIMIT_EXCEEDED: status.HTTP_422_UNPROCESSABLE_ENTITY,
        ...
        ErrorCode.SYSTEM_NOT_IMPLEMENTED: status.HTTP_501_NOT_IMPLEMENTED,
        ErrorCode.SYSTEM_SERVICE_UNAVAILABLE: status.HTTP_503_SERVICE_UNAVAILABLE,
    }
