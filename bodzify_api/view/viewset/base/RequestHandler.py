...
from bodzify_api.view.errors import APIErrorResponse


class RequestHandler:
    def validate_request_data(self, request_data: Dict[str, Any], serializer_class: type[Serializer], request: Request) -> None:
    ...
    def handle_validated_request(
        ...
        try:
            ...
            return APIErrorResponse.from_validation_error(exception)