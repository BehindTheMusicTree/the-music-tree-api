...
class Fields:
    ...
    LIB_TRACKS_INTERNAL = PlaylistFields.LIB_TRACKS_INTERNAL
    LIB_TRACKS_PUBLIC = PlaylistFields.LIB_TRACKS_PUBLIC
    LIB_TRACKS_COUNT_INTERNAL = PlaylistFields.LIB_TRACKS_COUNT_INTERNAL
    LIB_TRACKS_COUNT_PUBLIC = PlaylistFields.LIB_TRACKS_COUNT_PUBLIC
...
class ChildPlaylistSerializer(PlaylistSimpleSerializer):
    library_tracks_count = serializers.IntegerField(source=Fields.LIB_TRACKS_COUNT_PUBLIC)
    library_tracks = serializers.ListField(source=Fields.LIB_TRACKS_PUBLIC)
