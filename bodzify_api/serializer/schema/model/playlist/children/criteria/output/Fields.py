...
class Fields:
    ...
    LIB_TRACKS_PUBLIC = ChildPlaylistFields.LIB_TRACKS_NOT_ARCHIVED_PUBLIC
    LIB_TRACKS_COUNT_INTERNAL = ChildPlaylistFields.LIB_TRACKS_NOT_ARCHIVED_COUNT_INTERNAL
    LIB_TRACKS_COUNT_PUBLIC = ChildPlaylistFields.LIB_TRACKS_NOT_ARCHIVED_COUNT_PUBLIC
