...
from bodzify_api.serializer.schema.fingerprint_missing_cause.detailed import FingerprintMissingCauseDetailedSerializer
from bodzify_api.serializer.schema.musicbrainz.recording.detailed import MusicbrainzRecordingDetailedSerializer
