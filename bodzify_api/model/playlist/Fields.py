...
class Fields:
    ...
    LIB_TRACKS_INTERNAL = LibTrackMixinFields.LIB_TRACKS_NOT_ARCHIVED_INTERNAL
    LIB_TRACKS_PUBLIC = LibTrackMixinFields.LIB_TRACKS_NOT_ARCHIVED_PUBLIC
    LIB_TRACKS_COUNT_INTERNAL = LibTrackMixinFields.LIB_TRACKS_NOT_ARCHIVED_COUNT_INTERNAL
    LIB_TRACKS_COUNT_PUBLIC = LibTrackMixinFields.LIB_TRACKS_NOT_ARCHIVED_COUNT_PUBLIC
