...
class Fields:
    ...
    LIB_TRACKS_NOT_ARCHIVED_PUBLIC = ChildFields.LIB_TRACKS_NOT_ARCHIVED_PUBLIC
    LIB_TRACKS_NOT_ARCHIVED_INTERNAL = ChildFields.LIB_TRACKS_NOT_ARCHIVED_INTERNAL
    LIB_TRACKS_NOT_ARCHIVED_COUNT_PUBLIC = ChildFields.LIB_TRACKS_NOT_ARCHIVED_COUNT_PUBLIC
