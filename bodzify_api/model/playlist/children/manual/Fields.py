...
class Fields:
    ...
    LIB_TRACKS_NOT_ARCHIVED_PUBLIC = BaseFields.LIB_TRACKS_NOT_ARCHIVED_PUBLIC
    LIB_TRACKS_NOT_ARCHIVED_INTERNAL = BaseFields.LIB_TRACKS_NOT_ARCHIVED_INTERNAL
    LIB_TRACKS_NOT_ARCHIVED_COUNT_PUBLIC = BaseFields.LIB_TRACKS_NOT_ARCHIVED_COUNT_PUBLIC
    LIB_TRACKS_ARCHIVED_COUNT = BaseFields.LIB_TRACKS_ARCHIVED_COUNT_PUBLIC
