# Generated by Django 4.1 on 2023-02-08 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(default=None, max_length=22, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='PlaylistType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addedOn', models.DateTimeField(auto_now_add=True)),
                ('album', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bodzify_api.album')),
                ('artist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bodzify_api.artist')),
        ...
        migrations.AddField(
            model_name='album',
            name='albumArtists',
            field=models.ManyToManyField(default=None, to='bodzify_api.artist'),
        ),
        migrations.AddField(
            model_name='album',
            name='user',
