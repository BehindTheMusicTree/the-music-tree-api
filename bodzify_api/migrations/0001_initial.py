# Generated by Django 5.0.3 on 2025-02-17 15:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('code', models.PositiveIntegerField(choices=[(0, 'Audio Meta Amalysis Disabled'), (1, 'Track File Missing'), (2, 'Track File Fingerprinting Failed'), (3, 'Duration Below 1 Sec'), (4, 'Lookup Found No Matching Recording'), (5, 'Lookup Failed With Invalid Fingerprint Response Error Code'), (6, 'Lookup Failed With Internal Error Response Error Code'), (7, 'Lookup Failed With Unknown Response Error Code'), (8, 'Lookup Failed With Response Unknown Status Code'), (9, 'Lookup Failed For Unknown Reason')], primary_key=True, serialize=False, unique=True)),
        ...
        migrations.AddIndex(
            model_name='play',
            index=models.Index(fields=['user', 'content_type', 'object_pk'], name='bodzify_api_user_id_8d1a6a_idx'),
        ),
        migrations.AddIndex(
            model_name='librarytrack',
