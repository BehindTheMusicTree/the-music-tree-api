...
| 0  |                |            | 0   0   0  |            |            |         |
|0.5 |                |            |13   10  10 |            |            |         |
| 1  | 1   1   1   20 | 1       20 | 1   20  20 |  1      20 | 51      51 |         |
|1.5 |                |            |54   30  30 |            |            |         |
| 2  |64  64   64  40 | 64      40 |64   40  40 | 64      40 |102     102 |         |
|2.5 |                |            |118  50  50 |            |            |         |
| 3  |128 128 128  60 | 128     60 |128  60  60 | 128     60 |153     153 |         |
|3.5 |                |            |186  70  70 |            |            |         |
| 4  |196 196 196  80 | 196     80 |196  80  80 | 196     80 |204     204 |         |
|4.5 |                |            |242  90  90 |            |            |         |
| 5  |255 255 255 100 | 255    100 |255 100 100 | 255    100 |255     255 |         |
+----+----------------+------------+------------+------------+------------+---------+
|Prof| A   A   A   B  |  A   ✗  B  | A   B   B  |  A   ✗  B  | C   ✗   C  |    ✗    |
+----+----------------+------------+------------+------------+------------+---------+
