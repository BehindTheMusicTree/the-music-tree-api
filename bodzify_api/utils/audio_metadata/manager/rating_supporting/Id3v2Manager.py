...
class Id3v2Manager(RatingSupportingMetadataManager):
    ...
    def __init__(self, audio_file: AudioFile, normalized_rating_max_value: Optional[int] = None):
        metadata_keys_direct_map = {
            ...
            AppMetadataKey.ALBUM_ARTISTS_NAMES_STR: self.Id3TextFrames.ALBUM_ARTISTS_NAMES,
            AppMetadataKey.GENRE_NAME: self.Id3TextFrames.GENRE_NAME,
    ...
    def _get_eventually_normalized_rating_from_file(self, normalized_rating_max_value: int = 255):
