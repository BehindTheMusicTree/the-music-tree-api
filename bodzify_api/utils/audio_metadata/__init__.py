...
| - MD5 Checksum  |               |               |        ✓      |               |    ✓ (Flac)    |
+-----------------+---------------+---------------+---------------+---------------+----------------+
| Title           |     ✓ (30)    |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |    ✓ (256)     |
| Artist          |     ✓ (30)    |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |    ✓ (256)     |
| Album           |     ✓ (30)    |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |    ✓ (256)     |
| Album Artist    |               |   ✓ (~8M)     |    ✓ (~8M)    |               |    ✓ (256)     |
| Genre           | ✓ (1#) or str |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M#)     |    ✓ (256)     |
| Release Date    |     ✓ (4)     |   ✓ (10)      |    ✓ (10)     |   ✓ (10)      |      (10)      |
| Track Number    |     ✓ (1#)    |   ✓ (0-255#)  |   ✓ (Unlim#)  |  ✓ (Unlim#)   |      (0-999#)  |
| Rating          |               |   ✓ (0-255#)  |    ✓ (0-100#) |               |    ✓ (0-10#)   |
| BPM             |               |   ✓ (0-65535#)|   ✓ (0-65535#)|               |      (0-999#)  |
| Language        |               |   ✓ (3)       |    ✓ (3)      |               |    ✓ (3)       |
| Composer        |               |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |      (256)     |
| Publisher       |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Copyright       |               |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |      (256)     |
| Lyrics          |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (2000)    |
| Comment         |     ✓ (28)    |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |      (1000)    |
| Encoder         |               |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |      (256)     |
| URL             |               |    ✓ (2048)   |    ✓ (2048)   |               |      (2048)    |
| ISRC            |               |    ✓ (12)     |    ✓ (12)     |               |      (12)      |
| Mood            |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Key             |               |    ✓ (3)      |    ✓ (3)      |               |      (3)       |
...
| Remixer         |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Conductor       |               |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |      (256)     |
| Cover Art       |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (10MB#)   |
| Compilation     |               |    ✓ (1#)     |    ✓ (1#)     |               |      (1#)      |
| Media Type      |               |   ✓ (~8M)     |    ✓ (~8M)    |  ✓ (~1M)      |      (256)     |
| File Owner      |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
...
| Arranger        |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Version         |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Performance     |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Archival Location|              |               |               |   ✓ (~1M)     |      (256)     |
| Keywords        |               |               |               |   ✓ (~1M)     |      (256)     |
| Subject         |               |               |               |   ✓ (~1M)     |      (256)     |
| Original Artist |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Set Subtitle    |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
| Initial Key     |               |    ✓ (3)      |    ✓ (3)      |               |      (3)       |
| Involved People |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (1000)    |
| Musicians       |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (1000)    |
| Part of Set     |               |   ✓ (~8M)     |    ✓ (~8M)    |               |      (256)     |
+-----------------+---------------+---------------+---------------+---------------+----------------+
Legend:
- ✓: Supported
