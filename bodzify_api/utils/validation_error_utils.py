...
def raise_integrity_error(exc: IntegrityError, error_code: Union[str, FieldValidationErrorCode, None] = None) -> None:
    """
...
def handle_drf_validation_error(exc: ValidationError, error_code: Union[str, FieldValidationErrorCode]) -> None:
