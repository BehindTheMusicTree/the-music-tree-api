...
def setup_app_constants():
    ...
    LIB_TRACK_LANGUAGE_LEN_MAX = 250

    global MINE_TRACK_TITLE_LEN_MAX
    MINE_TRACK_TITLE_LEN_MAX = 250
    ...
    MB_RECORDING_TITLE_LEN_MAX = 250
    global MB_RECORDING_MISSING_CAUSE_CODE_LABEL_LEN_MAX
    MB_RECORDING_MISSING_CAUSE_CODE_LABEL_LEN_MAX = 255
