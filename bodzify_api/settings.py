...
def setup_app_constants():
    ...
    LIB_TRACK_LANGUAGE_LEN_MAX = 3

    global MINE_TRACK_TITLE_LEN_MAX
    MINE_TRACK_TITLE_LEN_MAX = 255
    ...
    ALBUM_NAME_LEN_MAX = 255
    global ALBUM_ARTISTS_NAMES_FIELD_LEN_MAX
    ALBUM_ARTISTS_NAMES_FIELD_LEN_MAX = 255
    global ARTIST_NAME_LEN_MAX
    ARTIST_NAME_LEN_MAX = 255
    global ARTISTS_NAMES_LEN_MAX
    ARTISTS_NAMES_LEN_MAX = 255
    ...
    FINGERPRINTING_ERROR_MESSAGE_LEN_MAX = 255
    global FINGERPRINTING_ERROR_CODE_LABEL_LEN_MAX
    FINGERPRINTING_ERROR_CODE_LABEL_LEN_MAX = 255
    ...
    MB_RECORDING_TITLE_LEN_MAX = 255
