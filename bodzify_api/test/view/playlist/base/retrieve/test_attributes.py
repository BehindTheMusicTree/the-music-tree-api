...
from bodzify_api.serializer.playlist.base.output.detailed import Fields as RetrieveFields
...
class TestCase(BasePlaylistTestCase):
    ...
    def test_retrieve_genre_then_ok(self):
        ...
        playlist_uuid = BasePlaylist.objects.get(criteria_playlist_child__criteria=genre,
                                                 criteria_playlist_child__type=CriteriaTypesId.GENRE).uuid
    ...
    def test_retrieve_tag_then_ok(self):
        ...
        playlist_uuid = BasePlaylist.objects.get(criteria_playlist_child__criteria=genre,
                                                 criteria_playlist_child__type=CriteriaTypesId.TAG).uuid
