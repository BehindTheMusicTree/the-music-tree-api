...
class TestCase(ManualPlaylistTestCase):
    ...
    def test_extra_field_then_error(self):
        ...
        assert self.bad_request_result_field_errors[0][ErrorResponseFields.CODE] == invalid_field
        assert self.bad_request_result_field_errors[0][
            ErrorResponseFields.CODE] == FieldValidationErrorCode.UNKNOWN_FIELD.value
