...
class TestCase(AlbumViewTestCase):
    ...
    #     assert response.status_code == status.HTTP_204_NO_CONTENT
    #     assert not Artist.objects.filter(user=self.test_user2, name=muse_artist.name).exists()
    ...
    #     assert response.status_code == status.HTTP_204_NO_CONTENT
    #     assert Artist.objects.filter(user=self.test_user2, name=muse_artist.name).exists()
    ...
    #     assert response.status_code == status.HTTP_204_NO_CONTENT
    #     assert not Artist.objects.filter(user=self.test_user2, name=matthew_artist.name).exists()
    ...
    def test_delete_then_dont_delete_album_artist_as_tracks_still_linked_to_it(self):
        ...
        assert response.status_code == status.HTTP_204_NO_CONTENT
        assert Artist.objects.filter(user=self.test_user2, name=matthew_artist.name).exists()
