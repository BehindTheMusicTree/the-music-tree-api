...
class TestCase(AlbumViewTestCase):
    ...
    def test_get(self):
        ...
        self.model_fixture_factory.create_album(name="All Killer No Filler", year=2001, album_artists=[sum41_artist],)
        ...
        self.model_fixture_factory.create_lib_track(title="Pieces", artist=sum41_artist, album=chuck_album)
