...
class TestCase(AlbumViewTestCase):
    ...
    def test(self):
        ...
        G(LibraryTrack, user=self.test_user, title="In Too Deep", artist=sum41_artist, album=chuck_album)
        G(LibraryTrack, user=self.test_user, title="We're All To Blame", artist=sum41_artist, album=chuck_album)
        G(LibraryTrack, user=self.test_user, title="Pieces", artist=sum41_artist, album=chuck_album)
