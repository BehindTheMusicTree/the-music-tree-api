...
class TestCase(GenreTestCase):
    ...
    def test_delete_not_root_then_lib_tracks_related_are_now_related_to_parent(self):
        ...
        lib_track_first = self.model_fixture_factory.create_lib_track_with_file(title='lib track first', genre=punk)
        lib_track_second = self.model_fixture_factory.create_lib_track_with_file(title='lib track second', genre=punk)
    ...
    def test_delete_root_then_lib_tracks_related_have_no_genre(self):
        rock = self.model_fixture_factory.create_genre(name='rock')
        lib_track_first = self.model_fixture_factory.create_lib_track_with_file(title='lib track first', genre=rock)
        lib_track_second = self.model_fixture_factory.create_lib_track_with_file(title='lib track second', genre=rock)
