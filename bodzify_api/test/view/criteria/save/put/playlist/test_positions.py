...
class TestCase(CriteriaTestCase):
    ...
    def test_new_parent_then_tracks_in_same_order_and_added_at_the_beginning_of_parent_of_parent(self):
        ...
        lib_track_position_relations = LibTrackPlaylistPositionRel.objects.filter(user=self.test_user2,
                                                                                  base_playlist=guitare_playlist)
    ...
    def test_new_parent_not_acendant_of_old_parent_then_update_positions_in_old_parent(self):
        ...
        track_fourth_in_rock = self.model_fixture_factory.create_lib_track_with_file(
            genre=rock_genre, title="Rock song 2")
        ...
        track_second_in_rock = self.model_fixture_factory.create_lib_track_with_file(
            genre=rock_genre, title="Rock song")
