...
class TestCase(GenreTestCase):
    ...
    def test_new_parent_then_tracks_in_same_order_and_added_at_the_beginning(self) -> None:
        ...
        lib_track_rock_added_second = self.model_fixture_factory.create_lib_track_with_file(
        ...
        lib_track_punk_added_third = self.model_fixture_factory.create_lib_track_with_file(
            title="punk song", genre=genre_punk, use_manager_for_genre_playlist_adding=True)
        lib_track_punk_added_fourth = self.model_fixture_factory.create_lib_track_with_file(
        ...
        rock_playlist_lib_tracks_not_archived_dict_by_position = \
            genre_rock.criteria_playlist.lib_tracks_not_archived_dict_by_position
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[1] == lib_track_punk_added_fourth
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[2] == lib_track_punk_added_third
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[3] == lib_track_rock_added_second
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[4] == lib_track_rock_added_first
    ...
    def test_new_parent_not_acendant_of_old_parent_then_update_positions_in_old_parent(self) -> None:
        ...
        rock_playlist_lib_tracks_not_archived_dict_by_position = \
            genre_rock.criteria_playlist.lib_tracks_not_archived_dict_by_position
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[1] == track_punk_added_forth
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[2] == track_rock_added_third
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[3] == track_punk_added_second
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[4] == track_rock_added_first
        ...
        rock_playlist_lib_tracks_not_archived_dict_by_position = \
            genre_rock.criteria_playlist.lib_tracks_not_archived_dict_by_position
        assert len(rock_playlist_lib_tracks_not_archived_dict_by_position) == 2
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[1] == track_rock_added_third
        assert rock_playlist_lib_tracks_not_archived_dict_by_position[2] == track_rock_added_first
