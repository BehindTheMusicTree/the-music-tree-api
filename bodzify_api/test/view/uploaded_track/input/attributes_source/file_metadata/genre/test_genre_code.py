...
class TestCase(LibTrackTestCase):
    ...
    def test_genre_code_from_riff_then_genre_name(self):
        response = self._post_uploaded_track(
            LibTrackTestFilename.GENRE_CODE_ID3V1_ABSTRACT_MP3, title='genre code abstract')
    ...
    def test_genre_code_unknown_from_riff_then_None(self):
        response = self._post_uploaded_track(
            LibTrackTestFilename.GENRE_CODE_ID3V1_UNKNOWN_MP3, title='genre code unknown')
