...
class TestCase(LibTrackTestCase):
    ...
    def test_album_in_both_then_take_from_data(self):
        ...
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_LONG_A_ID3V1_SMALL_MP3, **data_dict)
    ...
    def test_album_and_album_artists_in_data_and_only_album_in_metadata_then_take_from_data(self):
        ...
        response = self._post_uploaded_track(LibTrackTestFilename.ALBUM_KOKO_ID3V2_MP3, **data)
    ...
    def test_only_album_artists_in_data_and_album_in_metadata_then_400_bad_request(self):
        ...
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_LONG_A_ID3V2_SMALL_MP3, **data)
