...
class TestCase(GenreTestCase):
    ...
    def test_error_when_name_is_empty(self):
        rock_genre = self.model_fixture_factory.create_genre(name="Rock")
        response = self._put_genre(uuid=rock_genre.uuid, data_dict={PutFields.NAME: ""})
    ...
    def test_ok_then_update_linked_lib_track(self):
        ...
        track = self.model_fixture_factory.create_lib_track_with_file(title='polo', kwargs=data)
