...
class TestCase(GenreTestCase):
    ...
    def test_new_parent_then_tracks_in_same_order_and_added_at_the_beginning_of_parent_of_parent(self) -> None:
        ...
        lib_track_playlist_rels: list[LibTrackPlaylistRel] = \
            list(LibTrackPlaylistRel.objects.filter(user=self.test_user1, playlist=playlist_guitare))
    ...
    def test_new_parent_not_acendant_of_old_parent_then_update_positions_in_old_parent(self) -> None:
        ...
        track_fourth_in_rock = self.model_fixture_factory.create_lib_track_with_file(genre=genre_rock,
                                                                                     title="Rock song 2")
        self.model_fixture_factory.create_lib_track_with_file(genre=genre_punk, title="Punk song 2")
        track_second_in_rock = self.model_fixture_factory.create_lib_track_with_file(genre=genre_rock,
                                                                                     title="Rock song")
        self.model_fixture_factory.create_lib_track_with_file(genre=genre_punk, title="Punk song")
