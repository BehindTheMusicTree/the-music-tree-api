...
class TrackPostViewTestCaseRatingWinampMp3(TrackViewTestCase):

    fixtures = ['initial_data', 'TestUserData']
    sampleDirectoryRelativePath = "test/view/track/post/rating/winamp/mp3/sample/"

    """
    The uploaded mp3 track has a no rating from Winamp. The corresponding 
    ...
    """
    The uploaded mp3 track has a 1 star rating from Winamp. The corresponding 
    ...
    """
    The uploaded mp3 track has a 2 stars rating set from Winamp. The corresponding 
    ...
    """
    The uploaded mp3 track has a 3 stars rating set from Winamp. The corresponding 
    ...
    """
    The uploaded mp3 track has a 4 stars rating set from Winamp. The corresponding 
    ...
    """
    The uploaded mp3 track has a 5 stars rating set from Winamp. The corresponding 
