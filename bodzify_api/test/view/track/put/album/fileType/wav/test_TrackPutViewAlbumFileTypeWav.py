...
class TrackPutViewAlbumFileTypeWavTestCase(TrackViewTestCase):

    fixtures = ['initial_data', 'TestUserData', 'TestViewTrackPutDataAlbumFileTypeWav']
    sampleDirectoryRelativePath = "test/view/track/put/album/fileType/wav/sample/"
