...
class TrackPutViewTestCaseFileMp3(TrackViewTestCase):

    fixtures = ['initial_data', 'TestUserData', 'TestViewTrackPutDataFileMp3']
    sampleDirectoryRelativePath = "test/view/track/put/sample/FileMp3/"
    ...
    """
    def test_trackPutFileMp3WhenPreviousHadAllTags(self):
        ...
        assert trackMetadata[AudioMetadataService.METADATA_DICT_RATING_KEY] == 255 # max mp3 rating
    ...
    All the following tags were set and are now updated:
     ...
     Thus the corresponding tags in the mp3 file should be updated.
    """
    def test_trackPutFileMp3WhenPreviousHadNoTag(self):
