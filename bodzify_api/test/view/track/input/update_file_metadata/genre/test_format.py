...
class TestCase(LibTrackTestCase):
    ...
    def test_mp3_filled_then_ok(self):
        genre_name = 'metal'
        data = {PostFields.GENRE: genre_name}
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_LONG_A_ID3V1_SMALL_MP3, **data)
    ...
    def test_flac_empty_then_ok(self):
        genre_name = 'metal'
        data = {PostFields.GENRE: genre_name}
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_NONE_FLAC, **data)
    ...
    def test_flac_filled_then_ok(self):
        genre_name = 'metal'
        data = {PostFields.GENRE: genre_name}
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_LONG_A_VORBIS_SMALL_FLAC, **data)
    ...
    def test_wav_empty_then_ok(self):
        genre_name = 'Metal'
        data = {PostFields.GENRE: genre_name}
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_NONE_WAV, **data)
    ...
    def test_wav_filled_then_ok(self):
        genre_name = 'Metal'
        data = {PostFields.GENRE: genre_name}
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_LONG_A_RIFF_SMALL_WAV, **data)
