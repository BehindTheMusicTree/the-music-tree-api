...
from bodzify_api.test.view.track.input.update_file_metadata.LibTrackFileMetadataUpdatePositiveIntTestCase import (
    LibTrackFileMetadataUpdatePositiveIntTestCase
)
from bodzify_api.utils.audio_metadata.utils.AppMetadataKey import AppMetadataKey


class UpdateFileMetadataRatingTestCase(LibTrackFileMetadataUpdatePositiveIntTestCase):
    save_field = InputFields.RATING
