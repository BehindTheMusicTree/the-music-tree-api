...
class TestCase(NullableFieldTestCase):
    ...
    def test_not_provided_then_unchanged(self):
        ...
        lib_track = G(LibraryTrack, user=self.test_user, title="Love", genre=rap_criteria)
    ...
    def test_ok_when_updating_to_not_none(self):
        rap_criteria = G(Criteria, user=self.test_user, type=CRITERIA_TYPES_ID.GENRE, name="Rap")
        lib_track = G(LibraryTrack, user=self.test_user, title="koko", genre=rap_criteria)
        rock_criteria = G(Criteria, user=self.test_user, type=CRITERIA_TYPES_ID.GENRE, name="Rock")
        data = {PUT_FIELDS.GENRE_NAME: rock_criteria.name}  # type: ignore
    ...
    def test_not_none_then_update(self):
        genre_name = "rap"
        lib_track = G(LibraryTrack, user=self.test_user, title='lolo')
