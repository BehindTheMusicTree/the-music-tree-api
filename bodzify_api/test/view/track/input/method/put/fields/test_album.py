...
class TestCase(NullableFieldTestCase):
    ...
    def test_empty_then_none(self):
        ...
        response = self._put_lib_track(uuid=lib_track.uuid, data_dict={PutFields.ALBUM_NAME: ''})
    ...
    def test_not_none_then_update(self):
        ...
        response = self._put_lib_track(uuid=lib_track.uuid, data_dict={PutFields.ALBUM_NAME: album_new.name})
    ...
    def test_nothing_linked_to_old_album_anymore_then_delete(self):
        ...
        response = self._put_lib_track(uuid=lib_track.uuid, data_dict={PutFields.ALBUM_NAME: "Paul"})
