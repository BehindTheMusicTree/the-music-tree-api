...
class TestCase(LibTrackTestCase, PutBodyDataTestCase):
    ...
    def test_empty_then_none(self):
        ...
        response = self._put_lib_track(uuid=lib_track.uuid, **{PutFields.ARTISTS_NAMES_MULTIPART: []})
    ...
    def test_not_delete_old_one_because_a_track_linked_to_it(self):
        ...
        response = self._put_lib_track(uuid=track.uuid, **{PutFields.ARTISTS_NAMES_MULTIPART: [artist_name]})
        assert response.status_code == status.HTTP_200_OK
