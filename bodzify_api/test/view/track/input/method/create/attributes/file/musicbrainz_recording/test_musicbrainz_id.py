...
class TestCase(TrackTestCase):
    ...
    def test_not_found_then_none(self):
        ...
        assert self.saved_lib_track.track_file.musicbrainz_recording is None
    ...
    def test_drown_7m21_mp3_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        recording = self.saved_lib_track.track_file.musicbrainz_recording
        assert recording
    ...
    def test_totaleclipe_5m35_flac_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        track_musicbrainz_recording = self.saved_lib_track.track_file.musicbrainz_recording
    ...
    def test_different_format_but_same_musicbrainz_recording(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        recording1 = self.saved_lib_track.track_file.musicbrainz_recording
        assert recording1
