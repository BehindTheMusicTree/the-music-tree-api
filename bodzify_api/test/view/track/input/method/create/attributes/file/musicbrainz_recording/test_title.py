...
class TestCase(LibTrackTestCase):
    ...
    def test_drown_7m21_mp3_then_ok(self):
        ...
        assert self.saved_lib_track.track_file.musicbrainz_recording.title == "Drown (Massano remix)"
    ...
    def test_totaleclipe_5m35_flac_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.saved_lib_track.track_file.musicbrainz_recording
        assert self.saved_lib_track.track_file.musicbrainz_recording.title == "Total Eclipse of the Heart"
