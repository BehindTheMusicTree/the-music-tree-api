...
class TestCase(TrackTestCase):
    ...
    def test_one_then_ok(self):
        ...
        assert self.lib_track_saved.musicbrainz_recording.musicbrainz_artists.all(  # type: ignore
    ...
    def test_multiple_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        artists_uuids = [
            artist.uuid for artist in self.lib_track_saved.musicbrainz_recording.musicbrainz_artists.all()  # type: ignore
        ]
    ...
    def test_same_artist_then_same_uuid(self):
        ...
        first_track_musicbrainz_artist_uuid = \
            self.lib_track_saved.musicbrainz_recording.musicbrainz_artists.all()[0].uuid  # type: ignore
