...
class TestCase(LibTrackTestCase):
    ...
    def test_duration_greater_to_one_sec_then_ok(self):
        ...
        assert self.saved_lib_track.track_file.musicbrainz_recording.duration_in_sec == 181
    ...
    def test_musicbrainz_recording_is_missing_duration_then_none(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.saved_lib_track.track_file.musicbrainz_recording
        assert not self.saved_lib_track.track_file.musicbrainz_recording.duration_in_sec
