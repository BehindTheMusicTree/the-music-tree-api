...
class TestCase(TrackTestCase):
    ...
    def test_normal_wav_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.saved_lib_track.duration_in_sec == 472
    ...
    def test_wav_with_issues_while_reading_duration_from_mutagen_and_tynitag_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.saved_lib_track.duration_in_sec == 1
    ...
    def test_normal_mp3_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.saved_lib_track.duration_in_sec == 277
    ...
    def test_normal_flac_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.saved_lib_track.duration_in_sec == 440
