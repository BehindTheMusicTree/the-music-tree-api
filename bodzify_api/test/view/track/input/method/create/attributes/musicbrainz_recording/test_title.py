...
class TestCase(TrackTestCase):
    ...
    def test_drown_7m21_mp3_then_ok(self):
        ...
        assert self.lib_track_saved.musicbrainz_recording.title == "Drown (Massano remix)"  # type: ignore
    ...
    def test_totaleclipe_5m35_flac_then_ok(self):
        ...
        assert response.status_code == status.HTTP_201_CREATED
        assert self.lib_track_saved.musicbrainz_recording.title == "Total Eclipse of the Heart"  # type: ignore
