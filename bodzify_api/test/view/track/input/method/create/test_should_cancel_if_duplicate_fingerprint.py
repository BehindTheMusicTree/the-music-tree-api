...
from bodzify_api.serializer.schema.model.lib_track.input.post.Fields import Fields
...
class TestCase(LibTrackTestCase):
    ...
    def test_duplicate_fingerprint_and_must_cancel_if_duplicate_fingerprint_then_bad_request(self):
        ...
        assert error[ErrorResponseFields.CODE] == FieldValidationErrorCode.DUPLICATE_FINGERPRINT
