...
from bodzify_api.serializer.model.uploaded_track.input.Fields import InputFields as LibTrackInputFields
...
class TestCase(LibTrackTestCase):
    ...
    def test_wav_file_corrupted_then_400_bad_request(self):
        response = self._post_uploaded_track(LibTrackTestFilename.FORMAT_CORRUPTED_WAV, title="wav corrupted")
