...
class TestCase(LibTrackTestCase):
    ...
    def test_long_then_renamed(self):
        response = self._post_lib_track(LibTrackTestFilename.FILENAME_151_MP3)
    ...
    def test_same_filename_so_suffixe_added(self):
        self._post_lib_track(LibTrackTestFilename.METADATA_NONE_MP3)
        ...
        assert track1.track_file.filename == LibTrackTestFilename.METADATA_NONE_MP3
        assert track2.track_file.filename.startswith(LibTrackTestFilename.METADATA_NONE_MP3[:-4])
