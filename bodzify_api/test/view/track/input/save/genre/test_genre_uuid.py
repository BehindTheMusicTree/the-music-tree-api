...
class TestCase(ForeignKeyBodyDataTestCase, LibTrackTestCase):
    ...
    def test_non_existing_then_400(self):
        ...
        response = self._post_lib_track(TestLibTrackFilename.METADATA_NONE_MP3, genre_uuid=non_exisintg_uuid)
    ...
    def test_empty_then_none(self):
        response = self._post_lib_track(TestLibTrackFilename.METADATA_NONE_MP3, genre_uuid="")
