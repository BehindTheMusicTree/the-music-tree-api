...
from bodzify_api.serializer.schema.model.lib_track.input.extract.extract import Fields as ExtractFields
...
class TestCase(LibTrackTestCase, NullableBodyDataTestCase):
    ...
    def test_too_long_then_error(self):
        ...
        assert error[ErrorResponseFields.FIELD] == to_camel_case(ExtractFields.ALBUM_NAME)
