...
class TestCase(NotNullableCharBodyDataTestCase, LibTrackTestCase):
    ...
    def test_largest_then_ok(self):
        ...
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_NONE_MP3, **{PostFields.TITLE: value})
    ...
    def test_empty_then_400_bad_request(self):
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_NONE_MP3, **{PostFields.TITLE: ""})
    ...
    def test_multi_value_then_400_bad_request(self):
        response = self._post_uploaded_track(LibTrackTestFilename.METADATA_NONE_MP3, **{PostFields.TITLE: ["a", "b"]})
