...
class TestCase(LibTrackTestCase):
    ...
    def test_none_then_none(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ALBUM_KOKO_ID3V2_MP3)
    ...
    def test_3_separated_by_antislash_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_ANTISLASH_ID3V2)
    ...
    def test_3_separated_by_comma_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_COMMA_ID3V2)
    ...
    def test_3_separated_by_double_antislash_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_DOUBLE_ANTISLASH_ID3V2)
    ...
    def test_3_separated_by_double_slash_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_DOUBLE_SLASH_ID3V2)
    ...
    def test_3_multi_tags_and_slash_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_MULTI_TAGS_AND_SLASH_VORBIS)
    ...
    def test_3_multi_tags_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_MULTI_TAGS_VORBIS)
    ...
    def test_3_separated_by_semicolon_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_SEMICOLON_ID3V2)
    ...
    def test_3_separated_by_slash_then_ok(self):
        response = self._post_uploaded_track(LibTrackTestFilename.ARTISTS_ONE_TWO_THREE_SLASH_ID3V2)
