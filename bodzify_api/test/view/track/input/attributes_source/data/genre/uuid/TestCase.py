...
class TestCase(NullableUuidFieldFromDataTestCase):
    ...
    def test_value_then_ok(self):
        ...
        response = self._post_lib_track_with_generic_sample_no_tags(kwargs={PostFields.GENRE_UUID: genre_uuid})
    ...
    def test_empty_then_none(self):
        response = self._post_lib_track_with_generic_sample_no_tags(kwargs={PostFields.GENRE_UUID: ''})
        assert response.status_code == status.HTTP_201_CREATED
