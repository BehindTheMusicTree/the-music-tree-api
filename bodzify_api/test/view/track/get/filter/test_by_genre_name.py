...
class TestCase(LibTrackTestCase):
    ...
    def test_a_genre_name_contains_the_filter_then_return_its_track(self):
    ...
    def test_a_genre_name_contains_the_filter_in_another_case_then_return_its_track(self):
        genre_rock = self.model_fixture_factory.create_genre(name="Rock")
        track_life = self.model_fixture_factory.create_lib_track_with_file(title="Life", genre=genre_rock)
