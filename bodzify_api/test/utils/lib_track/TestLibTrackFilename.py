...
class TestLibTrackFilename(str, Enum):
    ...
    RATING_0_5_STAR_VORBIS_FLAC = "rating=0.5 star_vorbis.flac"

    RATING_1_STAR_ID3V2_MP3_TRAKTOR = "rating=1 star_id3v2_traktor.mp3"
    ...
    RATING_1_STAR_VORBIS_TRAKTOR_FLAC = "rating=1 star_vorbis_traktor.flac"
    RATING_1_STAR_VORBIS_FLAC = "rating=1 star_vorbis.flac"

    RATING_1_5_STAR_VORBIS_FLAC = "rating=1.5 star_vorbis.flac"

    RATING_2_STAR_ID3V2_MP3_TRAKTOR = "rating=2 star_id3v2_traktor.mp3"
    RATING_2_STAR_ID3V2_FLAC = "rating=2 star_id3v2.flac"
    RATING_2_STAR_VORBIS_TRAKTOR_FLAC = "rating=2 star_vorbis_traktor.flac"
    RATING_2_STAR_VORBIS_FLAC = "rating=2 star_vorbis.flac"

    RATING_2_5_STAR_VORBIS_FLAC = "rating=2.5 star_vorbis.flac"

    RATING_3_STAR_ID3V2_MP3_TRAKTOR = "rating=3 star_id3v2_traktor.mp3"
    RATING_3_STAR_ID3V2_FLAC = "rating=3 star_id3v2.flac"
    RATING_3_STAR_VORBIS_TRAKTOR_FLAC = "rating=3 star_vorbis_traktor.flac"
    RATING_3_STAR_VORBIS_FLAC = "rating=3 star_vorbis.flac"

    RATING_3_5_STAR_VORBIS_FLAC = "rating=3.5 star_vorbis.flac"

    RATING_4_STAR_ID3V2_MP3_TRAKTOR = "rating=4 star_id3v2_traktor.mp3"
    RATING_4_STAR_ID3V2_FLAC = "rating=4 star_id3v2.flac"
    RATING_4_STAR_VORBIS_TRAKTOR_FLAC = "rating=4 star_vorbis_traktor.flac"
    RATING_4_STAR_VORBIS_FLAC = "rating=4 star_vorbis.flac"

    RATING_4_5_STAR_VORBIS_FLAC = "rating=4.5 star_vorbis.flac"

    RATING_5_STAR_ID3V2_MP3_TRAKTOR = "rating=5 star_id3v2_traktor.mp3"
    RATING_5_STAR_ID3V2_FLAC = "rating=5 star_id3v2.flac"
    RATING_5_STAR_VORBIS_TRAKTOR_FLAC = "rating=5 star_vorbis_traktor.flac"
    RATING_5_STAR_VORBIS_FLAC = "rating=5 star_vorbis.flac"
