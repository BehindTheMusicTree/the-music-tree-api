...
from bodzify_api.view.error.FieldValidationResponseCode import FieldValidationResponseCode
    ...
    def filter(self, qs, value):
        if value == '':
            raise_validation_error(
                ...
                code=FieldValidationResponseCode.FIELD_BLANK.value,
        ...
        if value is not None:
            ...
            if normalized_value not in self.valid_values:
                raise_validation_error(
                    ...
                    code=FieldValidationResponseCode.FIELD_INVALID_ENUM.value,
                    field=str(self.field_name)
                )
