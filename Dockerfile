...
ARG INIT_IF NECESSARY_DB_AND_ROLE_SCRIPT_NAME
...
RUN for var in \
    ...
    INIT_IF NECESSARY_DB_AND_ROLE_SCRIPT_NAME; do \
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    INIT_IF NECESSARY_DB_AND_ROLE_SCRIPT=${DOCKER_HOME}/scripts/${INIT_IF NECESSARY_DB_AND_ROLE_SCRIPT_NAME}
