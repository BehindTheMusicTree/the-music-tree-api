...
required_vars=(
  ...
  AUDIO_FINGERPRINTER_GUNICORN_LOG_DIR_SYMLINK_TARGET
...
cat << EOF > ${SCRIPTS_DIR}$DOCKER_COMPOSE_PART_FILENAME
  ...
  audio_fingerprinter:
    ...
    volumes:
      ...
      - afp-flask-log-dir:$AUDIO_FINGERPRINTER_FLASK_LOG_DIR_SYMLINK_TARGET
      - afp-gunicorn-log-dir:$AUDIO_FINGERPRINTER_GUNICORN_LOG_DIR_SYMLINK_TARGET
    ports:
